...
export const COMMANDS = {
  ...
  status: { summary: "Show session, endpoints, grants and places", load: () => import("./commands/status.mjs") },
  doctor: { summary: "Diagnose a broken setup, including places", load: () => import("./commands/doctor.mjs") },
  register: { summary: "Admit an entity into the Registry", load: () => import("./commands/register.mjs") },
  deploy: { summary: "Record a live deployment", load: () => import("./commands/deploy.mjs") },
  ci: { summary: "Report and read CI through Antenna", load: () => import("./commands/ci.mjs") },
